...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/elm-vim/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after
set scrolloff=5
set shiftwidth=4
set showcmd
set smartcase
...
setlocal path=~/Projects/elm-tetris/src,~/Projects/elm-tetris/elm-stuff/packages/**/src,.,/usr/include,,
...
silent! normal! zE
let s:l = 29 - ((14 * winheight(0) + 18) / 37)
